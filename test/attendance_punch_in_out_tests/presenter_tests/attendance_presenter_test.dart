...
import 'package:wallpost/attendance_punch_in_out/entities/punch_in_from_app_permission.dart';
...
void main() {
  ...
  test('failure to load attendance_punch_in_out details', () async {
    //given
    ...
    verifyInOrder([
      ...
      () => view.showErrorMessage("Loading attendance_punch_in_out details failed",
          InvalidResponseException().userReadableMessage),
    ]);
    _verifyNoMoreInteractionsOnAllMocks();
  });

  test("loading attendance_punch_in_out details successfully", () async {
    //given
...
// 1. user is not punched in (attendance_punch_in_out details) and can punch in now + can punch in from app (call the two services)
