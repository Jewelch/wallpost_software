...
main() {
  ...
  test("creating items sales data url when selected date filter is today", () {
    ...
    expect(url, "${BaseUrls.restaurantUrlV2()}/companies/1/store/0/itemsalesreport/filters?date_filter_type=today");
  });
  ...
  test("creating item sales data url when selected date filter is yesterday", () {
    ...
    expect(url, "${BaseUrls.restaurantUrlV2()}/companies/1/store/0/itemsalesreport/filters?date_filter_type=yesterday");
  });
  ...
  test("creating item sales data url when selected date filter is this week", () {
    ...
    expect(url, "${BaseUrls.restaurantUrlV2()}/companies/1/store/0/itemsalesreport/filters?date_filter_type=this_week");
  });
  ...
  test("creating item sales data url when selected date filter is this year", () {
    ...
    expect(url, "${BaseUrls.restaurantUrlV2()}/companies/1/store/0/itemsalesreport/filters?date_filter_type=this_year");
  });
  ...
  test("creating item sales data url when selected date filter is last year", () {
    ...
    expect(url, "${BaseUrls.restaurantUrlV2()}/companies/1/store/0/itemsalesreport/filters?date_filter_type=last_year");
  });
