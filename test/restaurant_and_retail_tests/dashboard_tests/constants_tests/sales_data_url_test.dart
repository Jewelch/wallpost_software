...
main() {
  ...
  test("creating sales breakdown url when selected wise is category wise", () {
    ...
    var url = DashboardUrls.getSalesBreakDownsUrl("1", selectedWise, dateRangeFilter, DashboardContext.restaurant);
    ...
    url = DashboardUrls.getSalesBreakDownsUrl("1", selectedWise, dateRangeFilter, DashboardContext.retail);

    expect(url,
        '${BaseUrls.restaurantUrlV2()}/companies/1/store/0/consolidated_stats/sales_breakdown/by/category/mobile?date_filter_type=today&forRetail=true');
  });
