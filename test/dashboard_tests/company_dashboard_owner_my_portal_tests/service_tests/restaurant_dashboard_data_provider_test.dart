...
import 'package:wallpost/dashboard/company_dashboard_owner_my_portal/constants/owner_my_portal_dashboard_urls.dart';
...
void main() {
  ...
  test('api request is built and executed correctly', () async {
    ...
    expect(mockNetworkAdapter.apiRequest.url, OwnerMyPortalDashboardUrls.restaurantDataUrl('someCompanyId', 1, 2022));
  ...
  test('month is set to null if it is 0', () async {
    ...
    expect(
        mockNetworkAdapter.apiRequest.url, OwnerMyPortalDashboardUrls.restaurantDataUrl('someCompanyId', null, 2022));
  });
