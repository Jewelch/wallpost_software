...
import 'package:wallpost/dashboard/company_dashboard_owner_my_portal/services/crm_dashboard_data_provider.dart';
...
void main() {
  Map<String, dynamic> successfulResponse = Mocks.crmDashboardDataResponse;
  ...
  test('api request is built and executed correctly', () async {
    ...
    expect(mockNetworkAdapter.apiRequest.url, OwnerMyPortalDashboardUrls.crmDataUrl('someCompanyId', 1, 2022));
  ...
  test('month is set to null if it is 0', () async {
    ...
    expect(mockNetworkAdapter.apiRequest.url, OwnerMyPortalDashboardUrls.crmDataUrl('someCompanyId', null, 2022));
  });
