...
void main() {
  ...
  test('api request is built and executed correctly', () async {
    ...
    expect(mockNetworkAdapter.apiRequest.url, OwnerMyPortalDashboardUrls.hrDataUrl('someCompanyId', 1, 2022));
  ...
  test('month is set to null if it is 0', () async {
    ...
    expect(mockNetworkAdapter.apiRequest.url, OwnerMyPortalDashboardUrls.hrDataUrl('someCompanyId', null, 2022));
  });
