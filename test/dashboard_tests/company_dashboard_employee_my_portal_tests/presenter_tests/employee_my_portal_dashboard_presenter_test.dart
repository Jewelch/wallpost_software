...
import 'package:wallpost/dashboard/company_dashboard_employee_my_portal/entities/employee_my_portal_data.dart';
import 'package:wallpost/dashboard/company_dashboard_employee_my_portal/services/employee_my_portal_data_provider.dart';
import 'package:wallpost/dashboard/company_dashboard_employee_my_portal/ui/presenters/employee_my_portal_dashboard_presenter.dart';
import 'package:wallpost/dashboard/company_dashboard_employee_my_portal/ui/view_contracts/employee_my_portal_view.dart';
...
void main() {
  ...
  setUp(() {
    ...
    presenter = EmployeeMyPortalDashboardPresenter.initWith(
      view,
      dataProvider,
      companyProvider,
      notificationCenter,
  ...
  test('stop listening to notifications', () async {
    ...
    //then
    verifyInOrder([
      () => notificationCenter.removeObserverFromAllChannels(key: "employeeMyPortal"),
    ]);
    _verifyNoMoreInteractionsOnAllMocks();
  });
  ...
  group('tests for syncing the data in the background', () {
    ...
    test('retrieving updated data successfully with changes to approval count', () async {
      //given
      var existingData = MockEmployeeMyPortalData();
      ...
      //when
      var newData = MockEmployeeMyPortalData();
      ...
      //then
      expect(presenter.getTotalApprovalCount(), 6);
      verifyInOrder([
        () => dataProvider.get(),
        () => view.onDidLoadData(),
      ]);
