...
import 'package:wallpost/dashboard/company_dashboard_employee_my_portal/constants/employee_my_portal_dashboard_urls.dart';
...
void main() {
  Map<String, dynamic> successfulResponse = Mocks.employeeMyPortalDataResponse;
  var mockCompanyProvider = MockCompanyProvider();
  var mockNetworkAdapter = MockNetworkAdapter();
  var myPortalDataProvider = EmployeeMyPortalDataProvider.initWith(mockCompanyProvider, mockNetworkAdapter);
  ...
  test('api request is built and executed correctly', () async {
    ...
    expect(mockNetworkAdapter.apiRequest.url, EmployeeMyPortalDashboardUrls.employeeMyPortalDataUrl('someCompanyId'));
