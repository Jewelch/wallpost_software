...
import 'package:wallpost/dashboard/company_dashboard_manager_my_portal/ui/presenters/module_page_view_presenter.dart';
...
void main() {
  ...
  test("get modules", () {
    when(() => permissionsProvider.canAccessFinanceModule()).thenReturn(false);
    ...
    when(() => permissionsProvider.canAccessFinanceModule()).thenReturn(true);
    when(() => permissionsProvider.canAccessCrmModule()).thenReturn(false);
    when(() => permissionsProvider.canAccessHrModule()).thenReturn(false);
    when(() => permissionsProvider.canAccessRestaurantModule()).thenReturn(false);
    when(() => permissionsProvider.canAccessRetailModule()).thenReturn(false);
    expect(presenter.getNumberOfModules(), 1);
    expect(presenter.getModules(), [Module.Finance]);
    expect(presenter.getModuleNames(), [
      Module.Finance.toReadableString(),
    ]);
    ...
    expect(presenter.getModules(), [Module.Finance, Module.Crm]);
    expect(presenter.getModuleNames(), [
      Module.Finance.toReadableString(),
    ...
    expect(presenter.getModules(), [Module.Finance, Module.Crm, Module.Hr]);
    expect(presenter.getModuleNames(), [
      Module.Finance.toReadableString(),
      Module.Crm.toReadableString(),
    ...
    expect(presenter.getModules(), [Module.Finance, Module.Crm, Module.Hr, Module.Restaurant]);
    expect(presenter.getModuleNames(), [
      Module.Finance.toReadableString(),
      Module.Crm.toReadableString(),
      Module.Hr.toReadableString(),
    ...
    expect(presenter.getNumberOfModules(), 5);
    expect(presenter.getModules(), [Module.Finance, Module.Crm, Module.Hr, Module.Restaurant, Module.Retail]);
    expect(presenter.getModuleNames(), [
      Module.Finance.toReadableString(),
      Module.Crm.toReadableString(),
      Module.Hr.toReadableString(),
