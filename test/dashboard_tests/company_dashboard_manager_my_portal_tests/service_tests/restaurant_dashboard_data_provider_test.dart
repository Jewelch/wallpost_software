...
void main() {
  Map<String, dynamic> successfulResponse = Mocks.restaurantDashboardDataResponse;
  var mockCompanyProvider = MockCompanyProvider();
  var mockNetworkAdapter = MockNetworkAdapter();
  var dataProvider = RestaurantDashboardDataProvider.initWith(mockCompanyProvider, mockNetworkAdapter);
  ...
  test('api request is built and executed correctly', () async {
    ...
    expect(mockNetworkAdapter.apiRequest.url, ManagerMyPortalDashboardUrls.restaurantDataUrl('someCompanyId', 1, 2022));
  ...
  test('month is set to null if it is 0', () async {
    ...
    expect(
        mockNetworkAdapter.apiRequest.url, ManagerMyPortalDashboardUrls.restaurantDataUrl('someCompanyId', null, 2022));
  });
