...
void main() {
  Map<String, dynamic> successfulResponse = Mocks.financeDashboardDataResponse;
  var company = MockCompany();
  var mockCompanyProvider = MockCompanyProvider();
  var mockNetworkAdapter = MockNetworkAdapter();
  var dataProvider = FinanceDashboardDataProvider.initWith(mockCompanyProvider, mockNetworkAdapter);
  ...
  setUp(() {
    clearInteractions(company);
    clearInteractions(mockCompanyProvider);
  ...
  test('api request is built and executed correctly', () async {
    ...
    expect(mockNetworkAdapter.apiRequest.url, ManagerMyPortalDashboardUrls.financeDataUrl('someCompanyId', 1, 2022));
  ...
  test('month is set to null if it is 0', () async {
    ...
    expect(mockNetworkAdapter.apiRequest.url, ManagerMyPortalDashboardUrls.financeDataUrl('someCompanyId', null, 2022));
  });
  ...
  test('success', () async {
    ...
    try {
      ...
      verify(() => company.currency).called(1);
    } catch (e) {
