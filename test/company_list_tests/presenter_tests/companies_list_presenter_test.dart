...
void main() {
  ...
  test(
      'retrieving companies successfully with null financial summary and commpany groups ',
      () async {
    //given
  ...
  test(
      'retrieving companies successfully with null financial summary and no commpany groups ',
      () async {
    //given
    when(() => mockCompaniesListProvider.isLoading).thenReturn(false);
    when(() => mockCompaniesListProvider.get())
  ...
  test(
      'retrieving companies successfully with non null financial summary and no company groups',
      () async {
    //given
    when(() => mockCompaniesListProvider.isLoading).thenReturn(false);
    when(() => mockCompaniesListProvider.get())
    ...
    verifyInOrder([
      ...
      () => view.showLoader(),
      () => mockCompaniesListProvider.get(),
      () => view.showSummary(financialSummary),
      () => view.showSearchBar(),
      () => view.showCompanyList(_companyList),
      () => view.hideLoader()
    ]);
  ...
  test(
      'retrieving companies successfully with non null financial summary and company groups',
      () async {
    //given
    when(() => mockCompaniesListProvider.isLoading).thenReturn(false);
    when(() => mockCompaniesListProvider.get())
