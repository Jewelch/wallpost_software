...
void main() {
  ...
  // var requestItemsProvider = AllowedWPActionsProvider.initWith(mockNetworkAdapter, repository);
  // var companyId = "13";
  //
  // test('api request is built correctly', () async {
  //   when(() => repository.saveAllowedActionsForEmployee(any(), any())).thenAnswer((_) => Future.value(null));
  ...
  //     verify(() => repository.saveAllowedActionsForEmployee(any(), any()));
