...
void main() {
  ...
  test('SalesData model serialization throws a <MappingException> when data is invalid', () {
    try {
      AggregatedSalesData.fromJson(
          Mocks.specificSalesDataResponse(totalSales: 12000, netSales: '4000', costOfSales: '2700', grossOfProfit: 'sdfdsf40d')['data']);
    ...
    try {
      AggregatedSalesData.fromJson(
          Mocks.specificSalesDataResponse(totalSales: '12000', netSales: 4000, costOfSales: '2700', grossOfProfit: '4332dsda0')['data']);
    ...
    try {
      AggregatedSalesData.fromJson(
          Mocks.specificSalesDataResponse(totalSales: '12000', netSales: '4000', costOfSales: 2700, grossOfProfit: '40sad')['data']);
