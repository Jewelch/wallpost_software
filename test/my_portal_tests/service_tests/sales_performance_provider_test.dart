...
void main() {
  Map<String, dynamic> successfulResponse = Mocks.salesPerformanceResponse;
  ...
  test('response is ignored if it is from another session', () async {
    ...
    salesPerformanceProvider.getPerformance(2019).then((_) {
  ...
  test('success', () async {
    ...
    try {
      var salesPerformance = await salesPerformanceProvider.getPerformance(2019);
      expect(salesPerformance, isNotNull);
    } catch (e) {
  ...
  test('test loading flag is set to true when the service is executed', () async {
    ...
    salesPerformanceProvider.getPerformance(2019);

    expect(salesPerformanceProvider.isLoading, true);
  });
  ...
  test('test loading flag is reset after success', () async {
    ...
    expect(salesPerformanceProvider.isLoading, false);
  });
