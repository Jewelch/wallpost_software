...
void main() {
  ...
  var selectedCompanyUnreadNotificationsCountProvider = SelectedCompanyUnreadNotificationsCountProvider.initWith(
    mockCompanyProvider,
    mockNetworkAdapter,
  );
  ...
  test('api request is built and executed correctly', () async {
    ...
    var _ = await selectedCompanyUnreadNotificationsCountProvider.getCount();
  ...
  test('response is ignored if it is from another session', () async {
    ...
    selectedCompanyUnreadNotificationsCountProvider.getCount().then((_) {
  ...
  test('success', () async {
    ...
    try {
      var unreadNotificationCount = await selectedCompanyUnreadNotificationsCountProvider.getCount();
  ...
  test('test loading flag is set to true when the service is executed', () async {
    ...
    selectedCompanyUnreadNotificationsCountProvider.getCount();

    expect(selectedCompanyUnreadNotificationsCountProvider.isLoading, true);
  });
  ...
  test('test loading flag is reset after success', () async {
    ...
    expect(selectedCompanyUnreadNotificationsCountProvider.isLoading, false);
  });
