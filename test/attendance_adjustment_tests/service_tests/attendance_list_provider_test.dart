...
void main() {
  ...
  var attendanceListsProvider = AttendanceListProvider.initWith(mockEmployeeProvider, mockNetworkAdapter);
  ...
  test('api request is built correctly', () async {
    ...
    var _ = await attendanceListsProvider.get(month, year);
  ...
  test('test loading flag is set to true when the service is executed', () {
    ...
    attendanceListsProvider.get(month, year);
  ...
  test('response is ignored if it is from another session', () async {
    ...
    attendanceListsProvider.get(month, year).then((_) {
