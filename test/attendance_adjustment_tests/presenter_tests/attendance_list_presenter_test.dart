...
void main() {
  ...
  test('selected month and year is initialized successfully', () async {
    ...
    expect(presenter.getSelectedMonth(), AppYears.monthNames(year)[DateTime.now().month - 1]);
  ...
  test('get status color', () {
    ...
    expect(presenter.getStatusColorForItem(attendanceListItem2), presenter.absentColor);
  });
