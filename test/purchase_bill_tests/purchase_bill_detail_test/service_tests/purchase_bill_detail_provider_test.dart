...
void main() {
  Map<String, dynamic> successfulResponse = Mocks.purchaseBillDetailResponse;
  var mockNetworkAdapter = MockNetworkAdapter();
  var detailsProvider = PurchaseBillDetailProvider.initWith("someCompanyId", mockNetworkAdapter);

  test('api request is built and executed correctly', () async {
    Map<String, dynamic> requestParams = {};
    mockNetworkAdapter.succeed(successfulResponse);

    var _ = await detailsProvider.get("someBillId");

    expect(mockNetworkAdapter.apiRequest.url, PurchaseBillDetailUrls.getPurchaseBillDetailUrl("someCompanyId", "someBillId"));
  ...
  test('response is ignored if it is from another session', () async {
    ...
    detailsProvider.get("someBillId").then((_) {
  ...
  test('success', () async {
    ...
    try {
      var detail = await detailsProvider.get("someBillId");
  ...
  test('test loading flag is set to true when the service is executed', () async {
    ...
    detailsProvider.get("someBillId");
