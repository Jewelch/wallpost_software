...
import 'package:wallpost/leave/leave_create/services/leave_airport_list_provider.dart';
...
void main() {
  ...
  var leaveAirportListProvider = LeaveAirportListProvider.initWith(mockCompanyProvider, mockNetworkAdapter);
  ...
  test('api request is built and executed correctly', () async {
    ...
    expect(mockNetworkAdapter.apiRequest.url,
        CreateLeaveUrls.airportsListUrl('someCompanyId', 'v1EmpId', 'someSearchText', 1, 15));
