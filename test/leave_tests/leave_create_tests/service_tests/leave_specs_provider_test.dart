...
void main() {
  Map<String, dynamic> successfulResponse = Mocks.leaveSpecsResponse;
  var mockCompanyProvider = MockCompanyProvider();
  var mockNetworkAdapter = MockNetworkAdapter();
  var leaveSpecsProvider = LeaveSpecsProvider.initWith(mockCompanyProvider, mockNetworkAdapter);
  ...
  test('api request is built and executed correctly', () async {
    ...
    var _ = await leaveSpecsProvider.get();

    expect(mockNetworkAdapter.apiRequest.url, CreateLeaveUrls.leaveSpecsUrl('someCompanyId', 'v1EmpId'));
  ...
  test('success', () async {
    ...
    try {
      var specs = await leaveSpecsProvider.get();
      expect(specs.leaveTypes.length, 5);
    } catch (e) {
  ...
  test('test loading flag is set to true when the service is executed', () async {
    ...
    expect(leaveSpecsProvider.isLoading, true);
  });
  ...
  test('test loading flag is reset after success', () async {
    ...
    expect(leaveSpecsProvider.isLoading, false);
  });
