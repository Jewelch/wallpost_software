...
import 'package:wallpost/leave/leave_list/constants/leave_list_urls.dart';
...
void main() {
  ...
  var leaveListProvider = LeaveListProvider.initWith(mockCompanyProvider, mockNetworkAdapter);
  ...
  test('api request is built and executed correctly', () async {
    ...
    var _ = await leaveListProvider.getNext(LeaveListStatusFilter.all);

    expect(mockNetworkAdapter.apiRequest.url,
        LeaveListUrls.leaveListUrl('someCompanyId', 'v1EmpId', LeaveListStatusFilter.all, 1, 15));
  ...
  test('response is ignored if it is from another session', () async {
    ...
    leaveListProvider.getNext(LeaveListStatusFilter.all).then((_) {
  ...
  test('success', () async {
    ...
    try {
      var leaveListItem = await leaveListProvider.getNext(LeaveListStatusFilter.all);
  ...
  test('page number is updated after each call', () async {
    ...
    try {
      ...
      await leaveListProvider.getNext(LeaveListStatusFilter.all);
  ...
  test('test loading flag is set to true when the service is executed', () async {
    ...
    leaveListProvider.getNext(LeaveListStatusFilter.all);
