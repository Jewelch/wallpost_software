...
import 'package:wallpost/leave/leave_approval_list/constants/leave_approval_list_urls.dart';
...
void main() {
  ...
  var approvalListProvider = LeaveApprovalListProvider.initWith("someCompanyId", mockNetworkAdapter);
  ...
  test('api request is built and executed correctly', () async {
    ...
    expect(mockNetworkAdapter.apiRequest.url, LeaveApprovalListUrls.pendingApprovalListUrl('someCompanyId', 1, 15));
