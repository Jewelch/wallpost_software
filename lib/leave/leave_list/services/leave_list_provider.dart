...
import '../constants/leave_list_urls.dart';
...
class LeaveListProvider {
  ...
  LeaveListProvider.initWith(this._selectedCompanyProvider, this._networkAdapter);
  ...
  Future<List<LeaveListItem>> getNext(LeaveListStatusFilter status) async {
    var company = _selectedCompanyProvider.getSelectedCompanyForCurrentUser();
    var employee = company.employee;
    var url = LeaveListUrls.leaveListUrl(company.id, employee.v1Id, status, _pageNumber, _perPage);
