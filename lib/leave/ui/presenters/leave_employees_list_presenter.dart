...
import 'package:wallpost/leave/ui/views/leave_employee_list/leave_employee_list_tile.dart';
...
class EmployeesListPresenter {
  ...
  List<LeaveEmployee> _employees = [];
  List<LeaveEmployee> _selectedEmployees = [];
  ...
  List<LeaveEmployee> getSelectedEmployeesList() {
  ...
  bool isEmployeeSelected(LeaveEmployee employee) {
    for (LeaveEmployee selectedEmployee in _selectedEmployees) {
