...
class AppColors {
  ...
  static final Color filtersTextGreyColor = _getColorFromHex(AppColors._filtersGreyColor);

  static final Color filtersBackgroundGreyColor = _getColorFromHex(AppColors._filtersBackgroundGreyColor);
  ...
  static final Color statusRedColor = _getColorFromHex(AppColors._statusRedColor);
