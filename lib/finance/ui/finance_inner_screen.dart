...
import 'package:wallpost/finance/ui/views/finance_dashboard_appbar.dart';
import 'package:wallpost/finance/ui/views/finance_dashboard_loader.dart';
import 'package:wallpost/finance/ui/views/finance_filters.dart';
...
class FinanceInnerScreen extends StatefulWidget {
  ...
  @override
  State<FinanceInnerScreen> createState() => _FinanceDashBoardScreenState();
}

class _FinanceDashBoardScreenState extends State<FinanceInnerScreen> implements FinanceDasBoardView {
