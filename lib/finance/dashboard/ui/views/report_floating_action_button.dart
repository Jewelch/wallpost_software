...
import 'package:wallpost/finance/dashboard/ui/views/select_report_screen.dart';
...
class ReportsFloatingActionButton extends StatelessWidget {
  const ReportsFloatingActionButton({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          ScreenPresenter.present(SelectReportScreen(), context, slideDirection: SlideDirection.fromBottom);
        },
        child: Stack(
          children: [
            Container(
