...
class ReceivablesHeaderCard extends StatelessWidget {
  final ReceivablesPresenter _presenter;

  ReceivablesHeaderCard(this._presenter);
            ...
            Row(
              ...
              children: [
                _HeaderElement(
                  ...
                  label: "Overdue",
                  value: _presenter.receivablesReport.totalOverDuw,
                  valueColor: _presenter.getOverDueTextColor(_presenter.receivablesReport.totalOverDuw),
                ),
                _HeaderElement(
                  backgroundColor: AppColors.lightGray,
                  label: "Due",
                  value: _presenter.receivablesReport.totalDue,
