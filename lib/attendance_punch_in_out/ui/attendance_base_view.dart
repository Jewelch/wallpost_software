...
import 'package:wallpost/attendance_punch_in_out/ui/location_address_view.dart';
  ...
  Widget _getAttendanceButton() {
    ...
    if (!_punchInNowPermission.canPunchInNow)
      return DisableAttendanceButtonWithTimer(
        secondsToPunchIn: _punchInNowPermission.secondsTillPunchIn.toInt(),
        ...
        Expanded(
          child: Column(
            children: [
              ...
              Text('Late Punch In', style: TextStyle(color: Colors.purple)),
            ],
          ),
        ),
        Expanded(
          child: Column(
            children: [
              ...
              Text('Early Punch out', style: TextStyle(color: Colors.purple)),
            ],
          ),
        ),
        Expanded(
