          ...
          children: [
           ...
           if(_presenter.getNumberOfExpensesListItems() > 0)
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              child: _summaryValue(
                  "Sub Total", _presenter.getSubTotal(), AppColors.textColorBlack, AppColors.textColorBlueGray, ""),
            ),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              child: _summaryValue(
                  "Total", _presenter.getTotal(), AppColors.textColorBlack, AppColors.textColorBlueGray, ""),
            )
          ],
        ),
      ),
