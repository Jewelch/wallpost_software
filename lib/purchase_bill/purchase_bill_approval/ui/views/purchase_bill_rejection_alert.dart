...
class PurchaseBillRejectionAlert extends StatefulWidget {
  final String billId;
  final String companyId;
  final String supplierName;

  PurchaseBillRejectionAlert({
  ...
  @override
  State<PurchaseBillRejectionAlert> createState() => _PurchaseBillRejectionAlertState();
}

class _PurchaseBillRejectionAlertState extends State<PurchaseBillRejectionAlert>
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          Text("Do you want to reject ${widget.supplierName}'s purchase bill request?",
            ...
            Expanded(
              child: ItemNotifiable<bool>(
                ...
                builder: (context, showLoader) => RoundedRectangleActionButton(
                  ...
                  onPressed: () {
                    _presenter.reject(widget.companyId, widget.billId, _reasonTextController.text);
                  },
                ),
              ),
            ),
