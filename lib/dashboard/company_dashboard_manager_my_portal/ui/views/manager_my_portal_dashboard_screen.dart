...
import 'package:wallpost/dashboard/company_dashboard_manager_my_portal/ui/views/modules_view.dart';
...
import 'department_performance_view.dart';
import 'lix_view.dart';
import 'manager_dashboard_loader.dart';

class ManagerMyPortalDashboardScreen extends StatefulWidget {
  @override
  State<ManagerMyPortalDashboardScreen> createState() => _ManagerMyPortalDashboardScreenState();
}

class _ManagerMyPortalDashboardScreenState extends State<ManagerMyPortalDashboardScreen>
    with WidgetsBindingObserver
    implements ManagerMyPortalView {
  static const LOADER_VIEW = 1;
  static const ERROR_VIEW = 2;
  static const DATA_VIEW = 3;
  late ManagerMyPortalDashboardPresenter _presenter;
  ...
  @override
  void initState() {
    _presenter = ManagerMyPortalDashboardPresenter(this);
    _presenter.loadData();
        ...
        RefreshIndicator(
          ...
          child: ListView(
            ...
            children: [
              ...
              SizedBox(height: 16),
              _buildDepartmentPerformanceView(),
              SizedBox(height: 120),
            ],
          ),
        ),
  ...
  Widget _buildDepartmentPerformanceView() {
    return Container(
      margin: EdgeInsets.symmetric(horizontal: 12),
      height: 200,
      child: Column(
        children: [
          Expanded(child: DepartmentPerformanceView(_presenter)),
          SizedBox(height: 16),
