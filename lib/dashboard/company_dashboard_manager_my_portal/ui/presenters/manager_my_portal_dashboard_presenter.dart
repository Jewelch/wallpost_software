...
import '../../../company_dashboard_manager_my_portal/entities/manager_my_portal_data.dart';
import '../../../company_dashboard_manager_my_portal/services/manager_my_portal_data_provider.dart';
import '../models/manager_dashboard_filters.dart';
import '../view_contracts/manager_my_portal_view.dart';

class ManagerMyPortalDashboardPresenter {
  final ManagerMyPortalView _view;
  final ManagerMyPortalDataProvider _dataProvider;
  final SelectedCompanyProvider _selectedCompanyProvider;
  final NotificationCenter _notificationCenter;
  ManagerMyPortalData? _managerMyPortalData;
  var _filters = ManagerDashboardFilters();

  ManagerMyPortalDashboardPresenter(ManagerMyPortalView view)
      : this.initWith(
          view,
  ...
  ManagerMyPortalDashboardPresenter.initWith(
    this._view,
    this._dataProvider,
  ...
  void _startListeningToNotifications() {
    _notificationCenter.addExpenseApprovalRequiredObserver(
      NotificationObserver(key: "managerMyPortal", callback: (_) => syncDataInBackground()),
    );
  ...
  void stopListeningToNotifications() {
    _notificationCenter.removeObserverFromAllChannels(key: "managerMyPortal");
  }
  ...
  int getDepartmentPerformance() {
    return _managerMyPortalData!.departmentPerformance.toInt();
  }

  String getDepartmentPerformanceDisplayValue() {
    return "${getDepartmentPerformance()}%";
  }

  String getDepartmentPerformanceLabel() {
  ...
  int getTotalApprovalCount() {
    return _getTotalApprovalCount(_managerMyPortalData!);
  }

  int _getTotalApprovalCount(ManagerMyPortalData myPortalData) {
