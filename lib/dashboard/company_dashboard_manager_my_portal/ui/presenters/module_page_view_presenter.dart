...
class ModulePageViewPresenter {
  ...
  List<Module> getAllDashboardModules() {
    ...
    return [Module.Finance, Module.Crm, Module.Hr, Module.Restaurant, Module.Retail];
  }
  ...
  List<Module> getModules() {
    ...
    if (_permissionsProvider.canAccessFinanceModule()) allowedModules.add(Module.Finance);
