...
class _MyPortalScreenState extends State<MyPortalScreen> with SingleTickerProviderStateMixin implements MyPortalView {
                                        ...
                                        children: [
                                          Text("Congrats!",
                                              style: TextStyles.screenTitleTextStyle.copyWith(
                                                  color: Colors.white, fontSize: 22.0, fontWeight: FontWeight.w900)),
