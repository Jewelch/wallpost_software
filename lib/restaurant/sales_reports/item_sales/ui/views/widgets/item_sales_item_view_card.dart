...
class ItemSalesItemViewCard extends StatelessWidget {
  const ItemSalesItemViewCard(
    this.presenter, {
    super.key,
  });
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
              ...
              itemCount: presenter.getItemsListLength(),
              itemBuilder: (context, index) => Column(
                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(
                          width: quantityWidth,
                          child: Text(
                            presenter.getItemQtyAtIndex(index),
                            style: TextStyle(
                              overflow: TextOverflow.ellipsis,
                              color: AppColors.textColorBlack,
                              fontSize: 16,
                        ...
                        Expanded(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                presenter.getItemRevenueToDisplayAtIndex(index),
                  ...
                  index < presenter.getItemsListLength() - 1 ? Divider(height: 1) : SizedBox(),
                ],
              ),
            ),
          ],
