...
import 'sales_summary_loader_container.dart';

class SummarySalesLoader extends StatelessWidget {
  const SummarySalesLoader({Key? key}) : super(key: key);
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 40),
          Expanded(
              child: SummarySalesContainerLoader(
            height: 26,
            topRadius: 6,
            bottomRadius: 6,
          )),
