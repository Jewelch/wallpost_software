...
class SelectReportScreen extends StatefulWidget {
  static void show(BuildContext context, RestaurantDashboardPresenter presenter) {
    var modalSheetController = ModalSheetController();
    ModalSheetPresenter.present(
      height: 830,
      showBackGroundColor: false,
      context: context,
      content: SelectReportScreen(
  ...
  const SelectReportScreen({Key? key, required this.presenter, required this.modalSheetController})
      : super(key: key);
