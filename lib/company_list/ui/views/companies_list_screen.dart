...
class _CompanyListScreenState extends State<CompanyListScreen>
  ...
  var _companiesListNotifier = ItemNotifier<List<Company>?>();
  var _selectedCompanyNotifier = ItemNotifier<Company?>();
  var _groupSummary = ItemNotifier<GroupSummary>();
  ...
  var _companyGroups = ItemNotifier<List<CompaniesGroup>>();
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Container(
              height: 40,
              child: ItemNotifiable<List<CompaniesGroup>>(
  ...
  Widget _groupElement(int index, List<CompaniesGroup> companiesGroup) {
    return Container(
  ...
  Widget _summary() {
    return ItemNotifiable<GroupSummary>(
  ...
  Widget card(GroupSummary summary) {
    return Stack(
      children: [
  ...
  Widget shimmerEffectUIWidget() => ListTile(
        ...
        title: Align(
          ...
          child: MyShimmerEffectUI.rectangular(
              height: 18, width: MediaQuery.of(context).size.width * 0.35),
        ),
        subtitle: MyShimmerEffectUI.rectangular(height: 16),
      );

  Widget _getCompanies() {
    return ItemNotifiable<List<Company>?>(
  ...
  Widget _getCompanyCard(int index, List<Company> companyList) {
