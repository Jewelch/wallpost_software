                ...
                SizedBox(
                  ...
                  child: Column(children: [
                    ...
                    Padding(
                      ...
                      child: Text(taskListItem.progressPercentage.toString() + '%', style: TextStyles.labelTextStyle),
                    ),
                  ]),
                ),
                Expanded(
                        ...
                        children: [
                          Container(
                            child: Expanded(
                              child: Row(
                                children: [
                                  Text('Start : ', style: TextStyles.subTitleTextStyle.copyWith(color: Colors.black)),
                          ...
                          Container(
                            child: Expanded(
                              child: Row(
                                children: [
                                  Text('End :', style: TextStyles.subTitleTextStyle.copyWith(color: Colors.black)),
