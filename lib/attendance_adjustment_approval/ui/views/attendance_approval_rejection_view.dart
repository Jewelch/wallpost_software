...
class AttendanceApprovalRejectionView extends StatelessWidget {
  ...
  AttendanceApprovalRejectionView({
        ...
        builder: (context, isLoading) {
          return Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              Text("You want to reject ${approval.employeeName}'s payroll adjustment?",
